        ...
        if ($this->recipientPolicy->isRestricted()) {
            ...
            if (count($allowedMembers) !== count($members)) {
                throw new DomainException(
                    'Dit evenement kan met de actieve mailontvangersbeperking niet worden geannuleerd omdat niet alle betrokken leden op de toegelaten ontvangerslijst staan.'
                );
            }
        }
