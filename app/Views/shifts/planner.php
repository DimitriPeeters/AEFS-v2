...
<?= $this->component('page-header', [
    ...
    'actions' =>
        ...
        $this->component('button', [
            ...
            'href' => $helpers->url->to('/shifts/create?event=' . $event->eventId)
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <?= $this->component('button', [
                            ...
                            'href' => $helpers->url->to('/shifts/' . $shift->shiftId),
                        ...
                        <?= $this->component('button', [
                            ...
                            'href' => $helpers->url->to('/shifts/' . $shift->shiftId . '/edit'),
                        ...
                        <?php if ($shift->vergrendeld): ?>
                            ...
                            <?= $this->component('button', [
                                ...
                                'href' => $helpers->url->to('/shifts/' . $shift->shiftId . '/unlock'),
                        ...
                        <?php else: ?>
                            ...
                            <?= $this->component('button', [
                                ...
                                'href' => $helpers->url->to('/shifts/' . $shift->shiftId . '/lock'),
