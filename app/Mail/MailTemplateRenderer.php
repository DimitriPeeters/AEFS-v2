...
final class MailTemplateRenderer
{
    ...
    private function layout(
        ...
        return '<!doctype html><html lang="nl-BE"><head><meta charset="UTF-8">'
            ...
            . '<tr><td style="padding:20px 28px;background:#b5121b;color:#fff;font-weight:700;font-size:20px">AEFS Eventbeheer</td></tr>'
            . '<tr><td style="padding:28px;line-height:1.6">'
            . '<p style="margin:0 0 18px">'
            . $this->escape($this->greeting($firstName))
            . '</p>'
            . $content
            . '<p style="margin:28px 0 0">Met vriendelijke groet,<br><strong>AEFS</strong></p>'
            . '</td></tr></table>'
            . '<p style="margin:14px 0 0;color:#64748b;font-size:12px">Deze mail werd verstuurd vanuit AEFS Eventbeheer.</p>'
